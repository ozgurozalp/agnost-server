 ...
 *
 * Typically, a scheduled task runs according to its defined execution schedule. However, with Agnost's server-side client API by calling the {@link runOnce} method, you can manually run scheduled tasks ahead of their actual execution schedule.
 *
 * @export
 * @class Task
 */
export class Task<T extends TaskName> extends APIBase {
	 ...
	 */
	async runOnce(): Promise<TaskInfo> {
